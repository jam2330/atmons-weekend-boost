...
public class WeekendBoostConfig {
    ...
    // Tick intervals
    public static final int CHECK_INTERVAL_TICKS    = 1200;       // check every 60 seconds
    public static final int ANNOUNCE_INTERVAL_TICKS = 432000;     // re-announce every 6 hours
